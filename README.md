...
![Last test](https://github.com/andrelohmann/ansible-role-virtualbox/actions/workflows/test.yml/badge.svg)

## Content

Use this role to install a headless virtualbox
...
This role will always be updated to simply install the latest release of virtualbox, so there are no role variables available.
